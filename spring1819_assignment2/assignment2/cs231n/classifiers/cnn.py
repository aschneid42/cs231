...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        stride=2
        Hp,Wp = int(1+(H-pool_height)/stride), int(1+(W-pool_width)/stride) #pooling output
    ...
    def loss(self, X, y=None):
        ...
        X2, cache_fc1  = affine_relu_forward(X1,W2,b2)
        scores, cache_fc2  = affine_forward(X2,W3,b3)
        ...
        # propegate gradients
        dout, grads['W3'], grads['b3'] = affine_backward(dout,cache_fc2)
        dout, grads['W2'], grads['b2'] = affine_relu_backward(dout,cache_fc1)
